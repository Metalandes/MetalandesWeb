...
export default function Servicios({ servicios = [], titulo }: { servicios?: ServicioDoc[]; titulo?: Titulo }) {
  ...
  return (
    <section id="servicios" className="relative bg-[var(--tint)] py-16 md:py-24">
            ...
            >
              ...
              {s.imagen ? (
                <div className="relative h-56 w-full overflow-hidden md:h-64">
                  ...
                  />
                  {/* Sólo el borde inferior se funde con la tarjeta: la foto que
                      sube marketing se ve con sus colores reales. */}
